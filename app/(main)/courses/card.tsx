...
export const Card = ({
  ...
  return (
    <div
      onClick={() => onClick(id)}
      className={cn(
        "flex h-full min-h-[217px] min-w-[200px] cursor-pointer flex-col items-center justify-between rounded-xl border-2 border-b-[4px] bg-white p-3 pb-6 hover:bg-green-300 active:border-b-2",
